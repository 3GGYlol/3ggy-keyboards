...
type EggyKeyboardDocumentDataSlicesSlice = BentoBoxSlice | HeroSlice;

/**
 * Content for HomePage documents
 */
interface EggyKeyboardDocumentData {
  /**
   * Slice Zone field in *HomePage*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: eggy_keyboard.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/slices
   */
  slices: prismic.SliceZone<EggyKeyboardDocumentDataSlicesSlice>; /**
   * Meta Title field in *HomePage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: eggy_keyboard.meta_title
   * - **Tab**: SEO & Metadata
   ...
   * - **API ID Path**: eggy_keyboard.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: eggy_keyboard.meta_image
   * - **Tab**: SEO & Metadata
 ...
 *
 * - **API ID**: `eggy_keyboard`
 * - **Repeatable**: `false`
 * - **Documentation**: https://prismic.io/docs/content-modeling
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type EggyKeyboardDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithoutUID<
    Simplify<EggyKeyboardDocumentData>,
    "eggy_keyboard",
    Lang
  >;

export type AllDocumentTypes = EggyKeyboardDocument;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      EggyKeyboardDocument,
      EggyKeyboardDocumentData,
      EggyKeyboardDocumentDataSlicesSlice,
      AllDocumentTypes,
      BentoBoxSlice,
